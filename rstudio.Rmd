...
For more information about `tydyr` package, please refer to [here](https://www.cnblogs.com/nxld/p/6060533.html)
...
For "true" dot plot with `geom_dotplot()`:
```{r eval=FALSE}
...
![](images/bar3.png), ![](images/jitter1.png)

-----------------
### Advanced plotting with `ggplot2`
![](images/stat_functions.png)
...
```
![](images/smooth1.png), ![](images/smooth2.png)
...
```
![](images/smooth3.png), ![](images/smooth4.png), ![](images/smooth5.png)
